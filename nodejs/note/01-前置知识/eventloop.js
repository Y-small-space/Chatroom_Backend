/* 
  进程：
    ...
    好处就是安全，网页独立挂了之后不影响其他人，隔离不能互相访问
    ...
    网络线程，事件触发线程，EventLoop（定时器、事件 都会产生对应的线程）
    ...
    队列：浏览器默认有多个宏任务队列，但是我们只关心 eventLoop中的调用逻辑
    所以我们通常会说有一个宏任务队列。
    ...
    (requestFrameAnmation ui渲染 requestIDleback)网上说是宏任务 
    （和浏览器渲染相关的，我们称之为勾子）
